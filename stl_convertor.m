...
centerDistance=9.2;%9.2; %[cm] - Distance from scanner to center of turntable
zDelta=0.1;
rawData=load('earphones_open.txt'); %Load text file from SD Card
rawData(rawData<0)=0; %Remove erroneous scans from raw data
indeces=find(rawData==999); %Find indeces of '999' delimiter in text file, indicating end of z-height scan
...
r(:,end)=[]; % Delete last row of 999 delimiters.
...
surf2stl('earphones_open.stl',xInterp,yInterp,zInterp); %Export as STL file
